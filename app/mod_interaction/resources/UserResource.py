...
get_multiple_users_parser.add_argument(common.QUERY_ATTR_FILTER_FIELD, type=str, location="args")
get_multiple_users_parser.add_argument(common.QUERY_ATTR_FILTER_VALUE, type=str, location="args")
