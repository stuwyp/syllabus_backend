...
SINGLE_POST_STRUCTURE = {
    ...
    "topic": fields.Nested(topic_structure),
    "photo_list_json": fields.String,
    "real_uid": fields.Integer,
    "title": fields.String
}
...
post_parser.add_argument("topic_id", type=int, location="json")


# 必须的参数 content, uid, post_type, token
# 非必须参数  source description photo_list_json  topic title
...
# 新的对象的参数
SINGLE_POST_ACCEPT_VARIABLES = (
    "content", "description", "uid", "post_type", "token", "photo_list_json", "source", "topic_id", "title")

# 用于修改之前post过的数据
SINGLE_PUT_ACCEPT_VARIABLES = (
    "content", "description", "uid", "post_type", "id", "token", "photo_list_json", "source", "topic_id", "title")
